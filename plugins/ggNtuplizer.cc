  ...
  hltPrescaleProvider_(ps, consumesCollector(), *this)
{
  ...
  //ootphoton//
  OOTphotonCollection_       = consumes<View<pat::Photon> >            (ps.getParameter<InputTag>("ootPhotons"));
  //OOTPhotonsToken            = consumes<std::vector<pat::Photon> >     (ps.getParameter<edm::InputTag>("OOTPhotons"));
  //recoOOTphotonCollection_   = consumes<reco::PhotonCollection>        (ps.getParameter<InputTag>("ootPhotons"));
  /*
  oPhotonsToken              = consumes<View<pat::Photon> >            (ps.getParameter<InputTag>("oPhotonsToken"));
  */
  //////////
