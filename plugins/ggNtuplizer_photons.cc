...
void ggNtuplizer::branchesPhotons(TTree* tree) {
  ...
  tree->Branch("ophoMIPChi2",                      &phoMIPChi2_);
  tree->Branch("ophoMIPTotEnergy",         &ophoMIPTotEnergy_);
  tree->Branch("ophoMIPSlope",                     &phoMIPSlope_);
  tree->Branch("ophoMIPIntercept",                 &phoMIPIntercept_);
  tree->Branch("ophoMIPNhitCone",                  &phoMIPNhitCone_);
  tree->Branch("ophoMIPIsHalo",                    &phoMIPIsHalo_);
